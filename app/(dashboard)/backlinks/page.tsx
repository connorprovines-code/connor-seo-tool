...
export const metadata: Metadata = {
  title: 'Backlinks',
  description: 'Monitor backlinks across all projects',
}
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Monitor and analyze backlinks across all your projects
        </p>
      </div>
      ...
      {projects && projects.length > 0 ? (
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            Select a project to view its backlink profile:
          </p>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {projects.map((project) => (
              <Link
                key={project.id}
                href={`/projects/${project.id}/backlinks`}
        ...
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          ...
          <p className="text-gray-600 mb-6">
            Create a project to start monitoring backlinks
          </p>
